    ...
    def GaussianClassifier_test(self):
        ...
        if Ny>10000: 
            ...
            for epo in range(epoch):
                ...
                pp=GaussianClassifier.GaussianClassifier_test_calculatProbability(tmptestdata,mu,sigma,TL) 
                P[index,:]=pp
            ...
            P=GaussianClassifier.GaussianClassifier_test_calculatProbability(testdata,mu,sigma,TL)    
        return P
    
    def GaussianClassifier_test_calculatProbability(testdata,mu,sigma,TL):
        Ny,dim=testdata.shape
        P=(np.zeros([dim,Ny]))
